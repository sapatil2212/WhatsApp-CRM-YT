      ...
      <div className="relative min-h-screen w-full flex items-center justify-center bg-[var(--m-bg-primary)] px-4 overflow-hidden select-none">
        ...
        <Card className="w-full max-w-md border-[var(--m-border-primary)] bg-[var(--m-bg-glass)] shadow-[var(--m-shadow-card)] backdrop-blur-xl relative z-10 p-2">
          <CardHeader className="items-center text-center pb-4">
            ...
            <CardTitle className="text-xl font-bold text-[var(--m-text-heading)]">Check your email</CardTitle>
            <CardDescription className="text-xs text-[var(--m-text-tertiary)] mt-2">
              We&apos;ve sent a confirmation link to <span className="text-[var(--m-text-primary)] font-semibold">{email}</span>. Please verify your account.
            </CardDescription>
          </CardHeader>
          <CardContent className="pt-2">
            <Link href="/login">
              <Button
                variant="outline"
                className="w-full border-[var(--m-border-primary)] bg-[var(--m-bg-secondary)] hover:bg-[var(--m-bg-tertiary)] text-[var(--m-text-secondary)] hover:text-[var(--m-text-primary)] text-xs font-bold"
              >
                Back to sign in
              </Button>
            </Link>
